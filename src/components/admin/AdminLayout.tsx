  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col bg-bg-base">
        {import.meta.env.DEV && isDevMockAdminEnabled() ? (
          <p className="shrink-0 border-b border-amber-500/40 bg-amber-950/80 px-4 py-2 text-center text-xs text-amber-100/90">
            Dev: <code className="font-mono">VITE_DEV_MOCK_ADMIN</code> — доступ лише в UI. RPC з БД
            вимагатимуть реальний <code className="font-mono">role=admin</code> у <code className="font-mono">profiles</code>.
          </p>
        ) : null}
